...
set_config() {
    echo "请选择配置文件类型："
    echo "=============================="
    echo -e " ${GREEN}1、 vmess+tcp${NC}"
    echo -e " ${GREEN}2、 vmess+ws${NC}"
    echo -e " ${GREEN}3、 vmess+tcp+tls（需要域名）${NC}"
    echo -e " ${GREEN}4、 vmess+ws+tls（需要域名）${NC}"
    echo "=============================="
...
echo -e " ${GREEN}2、 升级 V2ray${NC}"
echo -e " ${GREEN}3、 卸载 V2ray${NC}"
echo "=============================="
echo -e " ${GREEN}4、 重新启动 V2ray${NC}"
echo -e " ${GREEN}5、 重新加载 V2ray${NC}"
echo -e " ${GREEN}6、 设置开机启动 V2ray${NC}"
echo -e " ${GREEN}7、 查看 V2ray 启动状态${NC}"
echo -e " ${GREEN}8、 查看 V2ray 开机启动设置${NC}"
echo -e " ${GREEN}9、 设置 V2ray 配置信息${NC}"
echo -e " ${GREEN}10、 查看 V2ray 配置信息${NC}"
echo "=============================="
echo -e " ${GREEN}0、 退出一键安装脚本${NC}"
echo ""
echo ""
echo -e " 运行状态："
echo -e " 开机自启："
